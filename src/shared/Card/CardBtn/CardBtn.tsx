...
import styles from './cardbtn.css';

interface ICardBtn{
  id: number;
}

export function CardBtn({id} :ICardBtn) {
  ...
  return (
    <button className={isLike || localStorage.getItem(`isLiked_${id}`)==='true' ? likeBtn : styles.cardBtn} onClick={handleClick}>
